 ...
 */
package com.bumbumapps.sudoku.controller;
...
import com.bumbumapps.sudoku.SudokuApp;
import com.bumbumapps.sudoku.controller.database.DatabaseHelper;
import com.bumbumapps.sudoku.controller.database.model.Level;
import com.bumbumapps.sudoku.controller.qqwing.Action;
import com.bumbumapps.sudoku.controller.qqwing.PrintStyle;
import com.bumbumapps.sudoku.controller.qqwing.QQWing;
import com.bumbumapps.sudoku.controller.qqwing.Symmetry;
import com.bumbumapps.sudoku.game.GameDifficulty;
import com.bumbumapps.sudoku.game.GameType;
import com.bumbumapps.sudoku.ui.MainActivity;
...
public class GeneratorService extends JobIntentService {
    ...
    private void showNotification(GameType gameType, GameDifficulty gameDifficulty) {
        ...
        builder.setContentIntent(PendingIntent.getActivity(this, 0, new Intent(this, MainActivity.class),PendingIntent.FLAG_MUTABLE));
