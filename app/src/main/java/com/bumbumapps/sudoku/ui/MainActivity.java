...
import com.bumbumapps.sudoku.controller.NewLevelManager;
...
public class MainActivity extends BaseActivity implements IImportDialogFragmentListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.ic_more).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                popupMenu.getMenuInflater().inflate(R.menu.menu_drawer_main,popupMenu.getMenu());
                    ...
                    handler.post(runnable=new Runnable() {
                        ...
                        public void run() {
                            if(newLevelManager.isLevelLoadable(gameType, gameDifficulty)) {
                                ...
                                intent1.putExtra("gameType", gameType.name());
                                intent1.putExtra("gameDifficulty", gameDifficulty.name());
                                if(intent1 != null) {
